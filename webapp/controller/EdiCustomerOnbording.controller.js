sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.olympus.apps.edi.controller.EdiCustomerOnbording", {
		handleRouteMatched: function(oEvent) {
			...
			this.aRadioButtonGroupIds = ["sap_List_Page_0-content-sap_m_RadioButtonGroup-1536152089822"];
		...
		convertTextToIndexFormatter: function(sTextValue) {
			var oRadioButtonGroup = this.byId("sap_List_Page_0-content-sap_m_RadioButtonGroup-1536152089822");
		...
		_onRadioButtonSelect: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("OneCustomer", oBindingContext, fnResolve, "");
		...
		_onRadioButtonSelect1: function(oEvent) {

			var oBindingContext = oEvent.getSource().getBindingContext();

			return new Promise(function(fnResolve) {

				this.doNavigate("Mass", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("EdiCustomerOnbording").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
